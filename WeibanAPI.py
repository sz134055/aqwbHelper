...
getTask = 'https://weiban.mycourse.cn/pharos/index/listStudyTask.do'  # 获取任务列表
    ...
    def getTask(self):
        ...
        if response['code'] == '0':
            ...
            for task in response['data']:
                task_list.append({'id':task['userProjectId'],'name':task['projectName'],'endTime':task['endTime']})
            return task_list

    def getProgress(self,preId=None):
        if preId:
            self.preUserProjectId = preId
